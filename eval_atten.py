...
import models.dawn_atten as dawn_atten
...
# dawn_atten (with attention)
parser_dwnn_atten = subparsers.add_parser('dawn_atten')
parser_dwnn_atten.add_argument("--regu_details", default=0.1, type=float)
parser_dwnn_atten.add_argument("--regu_approx", default=0.1, type=float)
parser_dwnn_atten.add_argument("--levels", default=4, type=int)
parser_dwnn_atten.add_argument("--first_conv", default=32, type=int)
parser_dwnn_atten.add_argument("--classifier", default='mode1', choices=['mode1','mode2','mode3'])
parser_dwnn_atten.add_argument("--kernel_size", type=int, default=3)
parser_dwnn_atten.add_argument("--no_bootleneck", default=False, action='store_true')
parser_dwnn_atten.add_argument("--share_weights", default=False, action='store_true')
parser_dwnn_atten.add_argument("--simple_lifting", default=False, action='store_true')
parser_dwnn_atten.add_argument("--haar_wavelet", default=False, action='store_true')
parser_dwnn_atten.add_argument('--warmup', default=False, action='store_true')

# dawn alias (maps to dawn_atten)
...
def main():
    ...
    # Normalize 'dawn' to 'dawn_atten' for backward compatibility
    if args.model == 'dawn':
        args.model = 'dawn_atten'
    ...
    if not USE_COLOR and args.model != "dawn_atten":
        raise RuntimeError("Only DAWN with attention supports gray images")
    ...
    elif args.model == 'dawn_atten':
        model = dawn_atten.DAWN(
