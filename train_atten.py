...
# DAWN with attention options
parser_dwnn = subparsers.add_parser('dawn_atten')
...
def main():
	...
	if not USE_COLOR and not args.model == "dawn_atten":
		raise "Only DAWN with attention support training with gray images"
	...
	if args.model == 'densenet':
		...
		model = dawn_atten.DAWN(NUM_CLASS, big_input=big_input,
